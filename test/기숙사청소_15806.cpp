...
// 해당 위치에 도착할 때 짝수면 앞으로 짝수번째날에 해당위치에 곰팡이가 생길것이고,
// 홀수 일 때 도착하면 홀수번째 날에 곰팡이가 생길 것,
// 둘 다면 앞으로 항상 곰팡이가 있음
// 곰팡이가 새로 생기면, 새로 생긴 곰팡이에서 갈 수 있는 위치로 간다음에
// 짝수 도착인지 홀수 도착인지 체크,
// 짝수 곰팡이랑 홀수 곰팡이는 다른 곰팡이임.
// 이걸 최대 t번 하는데, 만약 새로운 곰팡이가 없으면 그만 함. 그래서 금방 그만하게 될 것
// 
